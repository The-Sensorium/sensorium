                  ...
                  <p className="mt-1 flex items-center gap-2 text-xs text-on-surface-variant">
                    ...
                    {row.report_id && (
                      <Link
                        ...
                        className="inline-flex items-center gap-1 rounded-md bg-surface-container px-2.5 py-1 text-xs font-semibold text-on-surface transition-colors hover:bg-surface-container/70"
                      >
                        Open case
