                  ...
                  <p className="mt-1 flex items-center gap-2 text-xs text-on-surface-variant">
                    ...
                    {row.report_id && (
                      <Link
                        ...
                        className="inline-flex items-center gap-1 rounded-md bg-primary px-2.5 py-1 text-xs font-semibold text-on-primary transition-colors hover:bg-primary-container"
                      >
                        Open case
