...
const KLIPY_APP_KEY = process.env.EXPO_PUBLIC_KLIPY_APP_KEY as string | undefined
const KLIPY_ENDPOINT =
  (process.env.EXPO_PUBLIC_KLIPY_ENDPOINT as string | undefined) ?? 'https://api.klipy.com/api/v1'
